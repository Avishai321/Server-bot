...
@BotCommand(
        command = {BotCommands.SPOTIFY_BACKUP, BotCommands.STOP_SPOTIFY_BACKUP},
        category = HandlerCategory.STORAGE_AND_MEDIA,
        description = "Sync Spotify to Nextcloud",
        detailedHelp = "Executes SpotDL via system shell and updates Nextcloud database.",
        examples = {"/spotisync", "/stop_spotisync"}
)
